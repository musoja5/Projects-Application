    ...
    <head>
        ...
        <style>
            ...
            body {
                ...
                background-image: url('/images/deftec.jpg'); /* Replace with the path to your background image */
            ...
            .auth-links a {
                color: #000; /* Adjust link color to ensure visibility on card background */

                  ...
                  <div class="offcanvas offcanvas-start w-25" id="offcanvas" data-bs-keyboard="false" data-bs-backdrop="false" style="background-color:rgb(255, 230, 230);">
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <a href="{{ url('student.addclass') }}" class="btn btn-success"><i class="fa fa-undo" aria-hidden="true">  Add Class</i></a>
                                ...
                                <table class="table table-bordered table-striped table-hover table-success">
                                    ...
                                    @foreach ($StudClass as $item)
                                        ...
                                        <td>{{ $item->cse_cmd }}</td>
                                            ...
                                            <td>
                                            <a href="{{ url('edit-studclass/'.$item->id) }}" class="btn btn-success btn-sm"> <i class="fa fa-book  "> Edit</i></a>

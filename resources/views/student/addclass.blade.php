                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-md-12">
                                         ...
                                         <form action="{{ url('student.addclass') }}" method="POST" enctype="multipart/form-data">
                                          @csrf
                                          ...
                                          <div class="form-group">
                                            ...
                                            <input id="class_name" type="text" class="form-control @error('class_name') is-invalid @enderror" name="class_name" value="{{ old('class_name') }}" required autocomplete="class_name" autofocus style="font-style:italic">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="stud_number" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="year_end" required>
                                        </div>
                                        <div class="form-group">
                                        <label class="control-label">Course Commader</label>
                                        <input type="text" class="form-control" name="cse_cmd" required>
                                        </div>
                                         <div class="row mt-2">

                  ...
                  <div class="offcanvas offcanvas-start w-25" id="offcanvas" data-bs-keyboard="false" data-bs-backdrop="false" style="background-color:rgb(255, 230, 230);">
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <a href="{{ url('developer.add_project') }}" class="btn btn-success"><i class="fa fa-undo" aria-hidden="true">  Add Work</i></a>
                                
                                <a href="{{ route('report.dev_pdf') }}" class="btn btn-info">Download PDF Report</a>
                                ...
                                <table class="table table-bordered table-striped table-hover table-success">
                                    ...
                                    @foreach ($system as $item)
                                        ...
                                        <td>
                                            ...
                                            <td>
                                            <a href="{{ url('edit-system/'.$item->id) }}" class="btn btn-success btn-sm"> <i class="fa fa-pen"> Edit</i></a>
                                        </td>

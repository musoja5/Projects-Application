                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-md-12">
                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    <h4>Add System</h4>
                                                    <div class="col-md-12">
                                                    <a href="{{ url('developer.my_projects') }}" class="btn btn-primary float-end mb-2"><i class="fa fa-undo" aria-hidden="true">   Project List</i></a>
                                          ...
                                          <form action="{{ url('developer.add_project') }}" method="POST" enctype="multipart/form-data">
                                              @csrf              
                                        ...
                                        <div class="form-group">
                                                ...
                                                <textarea cols="50" rows="3" class="form-control" name="pdescription" required></textarea>
                                                </div>
                                         <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group mb-3 mt-3">
                                             <button type="submit" class="btn btn-success btn-sm">   <i class="fa fa-save">  Save System</i></button>
                                   </div>
